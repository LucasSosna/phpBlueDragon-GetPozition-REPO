...
<li class="active">'.$this->lang->line('a1084').'</li>
</ol>';
...
echo form_submit(array('name' => 'buttonstart', 'value' => ''.$this->lang->line('a1090').'', 'class' => 'btn btn-info btn-block'));
echo form_close();
